...
<form id="formulaire" class="w-style m-auto" action="<?= (isset($params['typemission']))? "/ECF/Typemissions/Edit/{$params['typemission']->getId()}/{$_SESSION['token']}" : "/ECF/Typemissions/Create/{$_SESSION['token']}" ?>" method="post">
