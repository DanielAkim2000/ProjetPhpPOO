...
<form id="formulaire" class="w-25 m-auto" action="<?= (isset($params['typeplanque']))? "/ECF/Typeplanques/Edit/{$params['typeplanque']->getId()}/{$_SESSION['token']}" : "/ECF/Typeplanques/Create/{$_SESSION['token']}" ?>" method="post">
