...
<form id="formulaire" class="w-25 m-auto" action="<?= (isset($params['speciality']))? "/ECF/Specialitys/Edit/{$params['speciality']->getId()}/{$_SESSION['token']}" : "/ECF/Specialitys/Create/{$_SESSION['token']}" ?>" method="post">
