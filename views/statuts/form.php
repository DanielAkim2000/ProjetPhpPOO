...
<form id="formulaire" class="w-style m-auto" action="<?= (isset($params['statut']))? "/ECF/Statuts/Edit/{$params['statut']->getId()}/{$_SESSION['token']}" : "/ECF/Statuts/Create/{$_SESSION['token']}" ?>" method="POST">
